...
pub(crate) static ALIASES: &[Alias] = &[
    ...
    Alias {
        method: Method::Get,
        path: "/firmware/available",
        ty: "firmware_available",
        document_param: None,
    ...
    Alias {
        ...
        ty: "config",
        document_param: None,
        summary: "Everything configured on this board, as one document",
    },
    // --- act --------------------------------------------------------------
    Alias {
        method: Method::Post,
